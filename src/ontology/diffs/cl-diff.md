...
#### Added
- [simultaneous with](http://purl.obolibrary.org/obo/RO_0002082) [definition](http://purl.obolibrary.org/obo/IAO_0000115) "x simultaneous with y iff &omega;(x) = &omega;(y) and &omega;(&alpha; ) = &omega;(&alpha;), where &alpha; is a function that maps a process to a start point, and &omega; is a function that maps a process to an end point and '=' indicates the same instance in time." 
