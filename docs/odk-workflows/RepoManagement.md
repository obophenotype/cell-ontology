...
1. Add an import statement to your `src/ontology/cl-edit.owl` file. We suggest to do this using a text editor, by simply copying an existing import declaration and renaming it to the new ontology import, for example as follows:
    ```
    ...
...
1. Providing a `components/mycomp.owl:` make target in `src/ontology/cl.Makefile`
...
1. Providing an additional attribute for the component in `src/ontology/cl-odk.yaml`, `source`,
